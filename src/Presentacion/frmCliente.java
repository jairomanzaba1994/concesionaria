...
public class frmCliente extends javax.swing.JFrame {
    ...
    public frmCliente() {
        ...
        tablaCliente.setModel(admin.mostrarTablaClientes(""));
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registro Del Cliente", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 18))); // NOI18N
                ...
                if (jcbTipoDocumento.getSelectedIndex() == 1) {
                    ...
                    if (verificarCedula == true) {
                        if (jcbSexo.getSelectedIndex() == 1) {
                            ...
                            registrarCliente(tipoDocumento, genero);
                            desactivarCuadrosDeTexto();
                        }
    ...
    private void btnCargarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarDatosActionPerformed
        ...
        if (fila >= 0) {
            ...
            txtNumeroDocumento.setText(tablaCliente.getValueAt(fila, 0).toString());
            txtNombres.setText(tablaCliente.getValueAt(fila, 1).toString());
            txtApellidos.setText(tablaCliente.getValueAt(fila, 2).toString());
            jcbTipoDocumento.setSelectedItem(tablaCliente.getValueAt(fila, 3).toString());
            jcbSexo.setSelectedItem(tablaCliente.getValueAt(fila, 4).toString());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (fila >= 0) {
            String datosFila = tablaCliente.getValueAt(fila, 0).toString();

            try {
                int opcion = JOptionPane.showConfirmDialog(null, "Seguro desea eliminar este dato?");

                if (opcion == JOptionPane.OK_OPTION) {
                    admin.eliminarCliente(datosFila);
                    tablaCliente.setModel(admin.mostrarTablaClientes(""));
                ...
                if (txtNombres.getText().isEmpty() || txtApellidos.getText().isEmpty() || txtNumeroDocumento.getText().isEmpty() || jcbTipoDocumento.getSelectedIndex() == 0 || jcbSexo.getSelectedIndex() == 0) {
                    ...
                    if (jcbTipoDocumento.getSelectedIndex() == 1) {
                        ...
                        if (verificarCedula == true) {
                            if (jcbSexo.getSelectedIndex() == 1) {
                                genero = jcbSexo.getItemAt(1);
                                modificarCliente(tipoDocumento, genero);
                                desactivarCuadrosDeTexto();
                            }
                            if (jcbSexo.getSelectedIndex() == 2) {
                                genero = jcbSexo.getItemAt(2);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        tablaCliente.setModel(admin.mostrarTablaClientes(txtBuscar.getText()));
    }//GEN-LAST:event_txtBuscarKeyReleased

    private void modificarCliente(String tipoDocumento, String genero) {
        cliente = new Persona(txtNombres.getText(), txtApellidos.getText(), tipoDocumento, txtNumeroDocumento.getText(), genero, txtCorreo.getText(), txtTelefono.getText());
    ...
    private void registrarCliente(String tipoDocumento, String genero) {
        cliente = new Persona(txtNombres.getText(), txtApellidos.getText(), tipoDocumento, txtNumeroDocumento.getText(), genero, txtCorreo.getText(), txtTelefono.getText());

        try {
            if (admin.existeCliente(txtNumeroDocumento.getText()) == true) {
                tablaCliente.setModel(admin.mostrarTablaClientes(""));
                JOptionPane.showMessageDialog(null, "El cliente que quiere registrar ya existe");
            } else {
