 ...
 */
public class frmListaVendedor extends javax.swing.JFrame {

    Administrador admin = new Administrador();
    
    /**
     * Creates new form frmListaVendedor
     */
    public frmListaVendedor() {
        initComponents();
        tablaListaVendedores.setModel(admin.mostrarTablaVendedor(""));
    }
    ...
    private void initComponents() {
        ...
        tablaListaVendedores = new javax.swing.JTable();
        ...
        tablaListaVendedores.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaListaVendedores);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        tablaListaVendedores.setModel(admin.mostrarTablaVendedor(txtBuscar.getText()));
    }//GEN-LAST:event_txtBuscarKeyReleased

    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed

        int fila = tablaListaVendedores.getSelectedRow();

        if (fila >= 0) {
            frmDatosContrato.txtNroDocumentoVendedor.setText(tablaListaVendedores.getValueAt(fila, 0).toString());
            this.show(false);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListaVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmListaVendedor().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable tablaListaVendedores;
