...
public class frmListaVehiculos extends javax.swing.JFrame {
    ...
    public frmListaVehiculos() {
        initComponents();
        tablaListaVehiculos.setModel(admin.mostrarTablaAutos(""));
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        tablaListaVehiculos.setModel(admin.mostrarTablaAutos(txtBuscar.getText()));
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (fila >= 0) {
            frmDatosContrato.txtPlacaVehiculo.setText(tablaListaVehiculos.getValueAt(fila, 0).toString());
            this.show(false);
        } else {
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        ...
        if (tipoDeUsuario == 2) {
            proceso.btnRegistrarVendedores.setEnabled(false);
            proceso.menuRegistrarVendedor.setEnabled(false);
            proceso.btnRegistrarCliente.setEnabled(false);
            proceso.menuRegistrarCiente.setEnabled(false);
            proceso.btnRegistrarAutos.setEnabled(false);
            proceso.btnRegistrarAutos.setEnabled(false);
            proceso.btnContrato.setEnabled(false);
            proceso.menuGenerarContrato.setEnabled(false);
            proceso.menuVerVendedores.setEnabled(false);
            proceso.menuVerCliente.setEnabled(false);
            proceso.menuRegistrarAuto.setEnabled(false); 
            proceso.menuListaContratos.setEnabled(false);
            proceso.menuAutosVendidos.setEnabled(false);
        }
